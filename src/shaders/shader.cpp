...
void Shader::setMat4(const std::string &name, const glm::mat4& M)  const                        { glUniformMatrix4fv(glGetUniformLocation(ID, name.c_str()), 1, GL_FALSE, &M[0][0]); } // must be in column major order
void Shader::setMat3(const std::string &name, const glm::mat3& M)  const                        { glUniformMatrix4fv(glGetUniformLocation(ID, name.c_str()), 1, GL_FALSE, &M[0][0]); } // couldve also used glm::value_ptr()
void Shader::setMat2(const std::string &name, const glm::mat2& M)  const                        { glUniformMatrix4fv(glGetUniformLocation(ID, name.c_str()), 1, GL_FALSE, &M[0][0]); }
